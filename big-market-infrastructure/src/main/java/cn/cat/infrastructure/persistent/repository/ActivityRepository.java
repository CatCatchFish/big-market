...
// 优先从缓存获取
    ...
    @Override
    public CreateOrderAggregate buildOrderAggregate(Long sku) {
        return null;
    }
    ...
    public void doSaveOrder(CreateOrderAggregate createOrderAggregate) {
        try {
            ...
            RaffleActivityOrder raffleActivityOrder = getRaffleActivityOrder(createOrderAggregate, activityOrderEntity);
    ...
    private static RaffleActivityOrder getRaffleActivityOrder(CreateOrderAggregate createOrderAggregate, ActivityOrderEntity activityOrderEntity) {
